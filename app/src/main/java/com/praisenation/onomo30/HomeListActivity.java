 ...
 * {@link HomeListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class HomeListActivity extends FragmentActivity
        implements HomeListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.home_detail_container) != null) {
            ...
            ((HomeListFragment) getSupportFragmentManager()
    ...
    /**
     * Callback method from {@link HomeListFragment.Callbacks}
